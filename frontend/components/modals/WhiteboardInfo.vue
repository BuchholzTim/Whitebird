    ...
    <div class="modal-card">
      ...
      <section class="modal-card-body">
        <div class="columns">
          <div class="column">
            <div class="column-l">
              <p class="text-muted">Computer Zoom</p>
              <p>Using mouse wheel and pointing to the target object.</p>
            </div>
            <div class="column-r">
              <div class="control">
                 <p class="text-muted">Mobile Zoom</p>
                 <p>Pinching on the target object.</p>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  mounted() {
    this.shareLink = `${location.protocol}//${location.hostname}/share/${this.canvasID}`
  },
  methods: {
    hideModal() {
