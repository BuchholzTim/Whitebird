...
<style scoped>
.hero.is-halfheight .hero-body > .container-hero,
.hero.is-fullheight .hero-body > .container-hero {
  flex-grow: 1;
  flex-shrink: 1;
}
...
.header-github-link.is-small img {
  height: 24px;
  width: 24px;
}
...
.navbar.is-fresh .container-hero {
  min-height: 4rem;
}
.hero .navbar {
  background: none;
...
.button.signup-button {
  font-size: 0.9rem;
  font-weight: 600;
  font-family: 'Papillo', sans-serif;
  padding: 24px 26px;
  width: 130px;
  border-color: #f39200;
}
